const styles = {
    ...
    heroHeadText:
        'text-eerieBlack font-black lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[90px] mt-2',
    heroSubText:
    ...
    sectionHeadTextLight:
        'text-indigo-200 font-black md:text-[60px] sm:text-[48px] xs:text-[40px] text-[30px] font-poppins',
    sectionSubText:
        'sm:text-[18px] text-[16px] text-taupe uppercase tracking-wider font-semibold font-poppins',
    sectionSubTextLight:
        'sm:text-[18px] text-[16px] text-indigo-300 uppercase tracking-wider font-semibold font-poppins',
};
